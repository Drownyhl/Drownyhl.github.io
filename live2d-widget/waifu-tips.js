...
function loadWidget(config) {
	...
	(function registerEventListener() {
		...
		document.querySelector("#waifu-tool .fa-times").addEventListener("click", () => {
			...
			showMessage("Hope you'll find the one.", 2000, 11);
		...
		devtools.toString = () => {
			showMessage("Wanna know more about me？", 6000, 9);
		};
		window.addEventListener("copy", () => {
			showMessage("Remeber to indicate the source！", 6000, 9);
		});
		window.addEventListener("visibilitychange", () => {
			if (!document.hidden) showMessage("Oops, you're back～", 6000, 9);
		});
	})();
